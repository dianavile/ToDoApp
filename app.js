...
function addTodo(e) {
  ...
  todoList.appendChild(todoDiv); //attach final Todo
}
...
function deleteTodo(e) {
  ...
  if (item.classList[0] === "trash-btn") {
    const todo = item.parentElement; // e.target.parentElement.remove();
    todo.classList.add("fall");
    removeLocalTodos(todo); //at the end
